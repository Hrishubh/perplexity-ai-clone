        ...
        <div className='flex justify-between items-end'>
          <Tabs defaultValue="Search" className="w-[400px]">
            ...
            <TabsList>
              ...
              <TabsTrigger value="Research" className={'text-primary'} onClick={()=>setSearchType('research')}><AtomIcon/>  Research</TabsTrigger>
            </TabsList>
          </Tabs>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                {AIModelsOptions.map((model, index)=>(
                  <DropdownMenuItem className='mb-1' key={index}>
                    <div>
                      <h2 className='text-s'>{model.name}</h2>
