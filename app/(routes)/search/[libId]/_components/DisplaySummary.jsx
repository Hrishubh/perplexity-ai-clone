		...
		<div>
			<ReactMarkdown
				components={{
					h1: ({ node, ...props }) => (
						<h1
							className="text-4xl font-bold text-black-800 mb-4 leading-snug"
							{...props}
						/>
					),
					...
					h2: ({ node, ...props }) => (
						<h2
							className="text-3xl font-semibold text-black-700 mb-3 leading-snug"
							{...props}
						/>
					),
					...
					h3: ({ node, ...props }) => (
						<h3
							className="text-2xl font-semibold text-black-600 mt-4 mb-2 leading-tight"
							{...props}
						/>
					),
